...
class Quadrotor():
    ...
    def plot_contour(self, contour_points,random_HenonPoints,building_faces):
        ...
        # Plot the building
        building_poly = Poly3DCollection(building_faces, facecolors='gray', linewidths=1, edgecolors='k', alpha=0.6)
        self.ax.add_collection3d(building_poly)
        self.ax.plot([],[], 'b--', label='Quadrotor Trajectory')
        #self.ax.scatter(x_random, y_random, z_random, color='r',s=10)
        self.ax.plot(x_random, y_random, z_random, 'm-',linewidth=0.5, label='trajectory')
...
initial_radius = 2  # Initial radius of the helix
