...
#ax.plot(0,0,0, color='red', linewidth=2,label =" $\hat{z}_n$")
#ax.plot(0,0,0, color='green', linewidth=2,label =" $\hat{y}_n$")
#ax.plot(0,0,0, color='purple', linewidth=2,label =" $\hat{x}_n$")
...
ax.set_zlim(-0.5,10)
#ax.legend()
ax.legend(loc='upper center', bbox_to_anchor=(0.5, .88), ncol=2, frameon=True,fontsize="14",scatterpoints=1, markerscale=2, handletextpad=0.5,)
...
ax2.set_ylabel(r"$y'$",fontsize ="35")
ax2.set_zlabel(r"$z'$",fontsize ="35")
...
# Plot lines connecting the random Henon points
ax4.plot(randomHenonPoints[:, 0], randomHenonPoints[:, 1], randomHenonPoints[:, 2], color='red', linewidth=1,label ="Hyperchaotic trajectory")
...
# Set labels and view
ax4.set_xlabel(r"$x'$",fontsize ="35")
ax4.set_ylabel(r"$y'$",fontsize ="35")
ax4.set_zlabel(r"$z'$",fontsize ="35")
ax4.set_zlim(-0.5,10)
ax4.legend(loc='upper center', bbox_to_anchor=(0.5, 0.85), ncol=2, frameon=True,fontsize="17",scatterpoints=1, markerscale=2, handletextpad=0.5,)
